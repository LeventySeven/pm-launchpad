  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#09090b] border border-zinc-800 w-full max-w-md rounded-xl p-6 shadow-lg animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto custom-scrollbar">
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 rounded-sm opacity-70 ring-offset-black transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-[rgba(36,182,255,1)] focus:ring-offset-2 disabled:pointer-events-none"
        >
        ...
        {isSuccess ? (
             <div className="flex flex-col items-center justify-center py-10">
                <CheckCircle size={48} className="text-[rgba(36,182,255,1)] mb-4 animate-bounce" />
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input 
                            ...
                            className="flex h-9 w-full rounded-md border border-zinc-800 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-zinc-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[rgba(36,182,255,1)] disabled:cursor-not-allowed disabled:opacity-50"
                        />
                    </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {CATEGORIES.filter(c => c.id !== 'ALL').map(cat => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-md text-xs font-medium border transition-all ${category === cat.id ? 'bg-[rgba(36,182,255,1)] text-black border-[rgba(36,182,255,1)]' : 'bg-transparent text-zinc-500 border-zinc-800 hover:border-zinc-600 hover:text-zinc-300'}`}
                                >
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <input 
                                ...
                                className="flex h-9 w-full rounded-md border border-zinc-800 bg-transparent pl-9 pr-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[rgba(36,182,255,1)] [color-scheme:dark]"
                            />
                    ...
                    {outcomeType === 'BINARY' ? (
                        <div className="p-4 bg-zinc-900/30 rounded-md border border-zinc-800 flex justify-between items-center">
                            ...
                            <div className="flex gap-2">
                                    <span className="bg-zinc-800 border border-zinc-700 text-[rgba(36,182,255,1)] text-[10px] font-bold px-2 py-1 rounded-sm">{lang === 'RU' ? 'ДА' : 'YES'}</span>
                                    <span className="bg-zinc-800 border border-zinc-700 text-[rgba(201,37,28,1)] text-[10px] font-bold px-2 py-1 rounded-sm">{lang === 'RU' ? 'НЕТ' : 'NO'}</span>
                            </div>
                        </div>
                    ) : (
                        <div className="space-y-3">
                            {customOutcomes.map((outcome, index) => (
                                <div key={index} className="flex gap-2">
                                    <input 
                                        ...
                                        className="flex h-9 w-full rounded-md border border-zinc-800 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors placeholder:text-zinc-600 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[rgba(36,182,255,1)]"
                                    />
                            ...
                            <button 
                                ...
                                className="w-full py-2 border border-dashed border-zinc-800 hover:border-zinc-600 rounded-md text-zinc-500 hover:text-[rgba(36,182,255,1)] text-xs uppercase font-bold transition-all flex items-center justify-center gap-2"
                            >
                                <Plus size={14} />
